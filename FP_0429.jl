...
m=Model()
optimizer_with_attributes(Cbc.Optimizer,  "maxSolutions" => 1, "logLevel "=>1, "seconds" => 300,"allowableGap "=>70)
index_x = 1: ncol
const_x = 1: nrow
...
for i in var
    set_lower_bound(i,xlb_dict[i])
    set_upper_bound(i,xub_dict[i])
end
