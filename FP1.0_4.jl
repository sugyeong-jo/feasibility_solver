...
JuMP.set_objective_coefficient(dist_LP,collect(keys(solution_k_1))[1],1.0 )

JuMP.set_objective_function(dist_LP, sum( x[i] for i in 1:length(solution_k_1) )) 
dist_LP= Model()
